...
from solar_atmospherics.modules import figure_out_gcd, l3b_cuts, cut_bad_fits
...
def initialize_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Amount to thin the given input fules by.  For example --thin 5 uses 20% of the data.",
    )
...
def main(infile, outfile, gcd, n=-1):
    from I3Tray import *
